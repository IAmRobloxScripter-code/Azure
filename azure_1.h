...
typedef struct AST_NODE_LOOP_STMT AST_NODE_LOOP_STMT;
typedef struct AST_NODE_IS_STMT AST_NODE_IS_STMT;
...
typedef struct AST_NODE {
  ...
  union {
    ...
    AST_NODE_LOOP_STMT* LOOP_DECL_STMT;
    ...
    AST_NODE_IS_STMT* IS_DECL_STMT;
  };
} AST_NODE;

struct AST_NODE_IS_STMT {
  AST_NODE* condition;
  AST_NODE_ARRAY* body;
  AST_NODE_ARRAY* else_body;
};

struct AST_NODE_LOOP_STMT {
  AST_NODE_ARRAY* body;
};
